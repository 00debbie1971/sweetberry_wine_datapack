...
tellraw @s ["",{"text":"You have crafted ","color":"gold","italic":true},{"text":"Cherry Berry Blossom Wine","color":"gold","italic":true},{"text":"!","color":"gold","italic":true}]
# Add the new item to the player's inventory
give @s minecraft:honey_bottle{CustomModelData:3,display:{Name:'{"text":"Cherry Berry Blossom Wine","color":"gold","italic":true}',Lore:['{"text":"Crafted with love","italic":true}']}} 1
...
advancement revoke @s only cherry_berry_vineyard:cherry_berry_blossom_wine_crafted cherry_berry_blossom_wine_crafted
