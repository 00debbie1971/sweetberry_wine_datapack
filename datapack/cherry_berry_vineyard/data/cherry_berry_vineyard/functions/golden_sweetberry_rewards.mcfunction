...
tellraw @s ["",{"text":"You have crafted ","color":"gold","italic":true},{"text":"Golden Sweetberry Wine","color":"gold","italic":true},{"text":"!","color":"gold","italic":true}]
# Add the new item to the player's inventory
give @s minecraft:honey_bottle{CustomModelData:2,display:{Name:'{"text":"Golden Sweetberry Wine","color":"gold","italic":true}',Lore:['{"text":"Crafted with love","italic":true}']}} 1
...
advancement revoke @s only cherry_berry_vineyard:golden_sweetberry_wine_crafted golden_sweetberry_wine_crafted
